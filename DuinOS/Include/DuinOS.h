...
#define delay(ticks) vTaskDelay(ticks)  // recomendação do FreeRtos, usar vTaskDelayUntil
//#define delay(ticks)  \vTaskDelayUntil( xTaskGetTickCount(), ( 1000 / portTICK_RATE_MS )  );
