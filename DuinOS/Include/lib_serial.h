...
UBaseType_t xSerialGetChar( xComPortHandlePtr pxPort, UBaseType_t *pcRxedChar );
UBaseType_t xSerialPutChar( xComPortHandlePtr pxPort, const UBaseType_t cOutChar );
/*-----------------------------------------------------------*/
...
#define	portSERIAL_BUFFER_RX	32		//era 32 Define the size of the serial receive buffer.
